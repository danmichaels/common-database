 ...
 */
public class DataSourceConnectionProviderImplTest {
	...
	public void testGetConnectionWithParams() throws Exception {
		...
		// insert data
		BaseDataSource dataSource = new BaseDataSource(databaseConfiguration, databasePoolConfiguration, new FirebirdTransactionInitPolicy());
		ConnectionProvider connectionProvider = new DataSourceConnectionProviderImpl(dataSource, new FirebirdTransactionInitPolicy());
